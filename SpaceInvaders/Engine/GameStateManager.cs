...
namespace SpaceInvaders.Engine
{
        ...
        /// </summary>
        internal class GameStateManager : GameComponent
        {
                ...
                public GameStateManager(BaseGame game) : this(game, 5000, 100) { }
                ...
                public GameStateManager(BaseGame game, int startingDrawOrder, int drawOrderDelta) : base(game)
                {
                ...
                {
                        GameState removedState = _GameStates.Pop();
