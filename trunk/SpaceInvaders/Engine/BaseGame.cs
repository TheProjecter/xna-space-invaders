...
{
    internal abstract class BaseGame<TypeOfGame> : Game where TypeOfGame : BaseGame<TypeOfGame>
    {
        private readonly GraphicsDeviceManager _Graphics;
        private SpriteBatch _SpriteBatch;
        private GameStateManager<TypeOfGame> _GameStateManager;
        ...
        protected BaseGame(string windowTitle, int screenWidth, int screenHeight)
            : base()
        {
        ...
        /// </summary>
        protected GameStateManager<TypeOfGame> GameStateManager
        {
        ...
        protected override void Initialize()
        {
            ...
            _GameStateManager = new GameStateManager<TypeOfGame>((TypeOfGame) this);
